...
export default async function OrcamentoDetalhePage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {!jaConvertido && (
        <form action={criarAmbienteComId} className={`flex flex-col gap-3 sm:flex-row ${CARD}`}>
          <input
            name="nome"
  ...
  return (
    <section className={`flex flex-col gap-5 ${CARD}`}>
      ...
      <div className="flex items-center justify-between gap-3">
        <form action={atualizarComId} className="flex flex-1 items-center gap-2">
          <input
            name="nome"
      ...
      {/* 3. Custo e lucro */}
      <div className="flex flex-col gap-3 border-t border-tertiary-fixed pt-4">
        <p className={LABEL}>2. Custo e lucro</p>

        <form action={atualizarPercentuaisComId} className="flex flex-wrap items-end gap-4">
      ...
      <div className="flex flex-col gap-3 border-t border-tertiary-fixed pt-4">
        <div>
          <p className={LABEL}>3. Comissões e encargos</p>
          <p className="text-body-md text-on-surface-variant">
        ...
        <div className="border-t border-tertiary-fixed pt-2">
